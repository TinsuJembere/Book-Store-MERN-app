    ...
    <div className=" rounded-lg transition-shadow duration-300">
        ...
        >
            ...
            <div>
                ...
                <button className="bg-primary  flex items-center gap-1 px-2 py-2 rounded-md text-base font-secondary font-sm hover:bg-secondary hover:text-white transition-all duration-200 cursor-pointer">
